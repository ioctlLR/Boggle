...
namespace Boggle
{
	...
	public class Program
	{
		...
		// our two known standard boards, then a 5x5, a 10x10, and a 50x50 non-standard boards
		[Params("ritqwtagsceopkyr"
			,"gnessripetaltseb"
			,"mekrzdanrsefqcehtuarooibi"
			//,"zfonsdlrsooaoetpumbeoixerkryahcnpanthclntawthilystarvmndebaeesoistvteeityiheugritjolqdfeewgnwuhsoerk"
		...
		public void Run()
		{
			var e = Solver.Solve(Board).GetEnumerator();
			while (e.MoveNext()) { }
			Solver.Reset();
		}
	}
